...
window.isCameriere = window.arrivaDaCameriere;
    ...
    if (parametriUrl.sessione) {
        try {
            ...
            if (info.success) {
                ...
                // Se arriva dal cameriere (ha tavolo+cliente nell'URL) non bloccare mai
                const arrivaDaCam = !!(parametriUrl.cliente && parametriUrl.sessione_cliente_id);
    ...
    // Recupero da localStorage SOLO se l'URL ha parametri validi
